...
//
// SusyIsoEff 
// Executable auto-generated with SusyNtuple/make_susy_skeleton on 2018-08-30 12:13
//
//
//////////////////////////////////////////////////////
...
void help()
{
    ...
    cout << "   SusyIsoEff -i susyNt.root -n 500" << endl;
    cout << "----------------------------------------------------------" << endl;
}
...
int main(int argc, char** argv)
{
    ...
    for(int i = 1; i < argc; i++) {
        if      (strcmp(argv[i], "-n") == 0) n_events = atoi(argv[++i]);
            ...
            cout << "SusyIsoEff    Unknown command line argument '" << argv[i] << "', exiting" << endl;
            help();
            return 1;
        }
    } // i
    ...
    if(input.empty()) {
        cout << "SusyIsoEff    You must specify an input" << endl;
        return 1;
    }
    ...
    /////////////////////////////////////////////////////////
    SusyStop2lIsoEff* analysis = new SusyStop2lIsoEff();
    ...
    cout << endl;
    cout << "SusyIsoEff    Analysis loop done" << endl;
